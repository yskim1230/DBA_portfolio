...
> 현재 업로드 자료에는 “이중화 방식(예: AlwaysOn AG / Log Shipping / Mirroring 등)”의 직접 스크립트는 보이지 않습니다.
> 따라서 이 섹션은 **전환/대기 서버 관점의 검증 체크리스트**로 작성하고, 실제 수행한 방식의 캡처/로그를 추가 첨부하는 구성이 좋습니다.
